 ...
 * @author Klaus
 */
public class v_admkasir extends javax.swing.JFrame {
    M_kasir model = new M_kasir();
    private String id, pos, nm;
    DecimalFormat kursIndonesia = (DecimalFormat) DecimalFormat.getCurrencyInstance();
    DecimalFormatSymbols formatRp = new DecimalFormatSymbols();
    /**
     * Creates new form v_admkasir
     * @param id_user
     * @param nama
     * @param posisi
     */
    public v_admkasir(String id_user, String nama, String posisi) {
        initComponents();
        this.OptionsFrame();
        this.tanggal();
        model.koneksi();
    ...
    private void proses(){
        ...
        model.setNoFaktur(String.valueOf(this.tnoo1.getText()));
    ...
    private void initComponents() {
        ...
        tnoo1 = new javax.swing.JTextField();
        ...
        sidepane2.add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 320, 230, 50));
        ...
        sidepane2.add(item, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 440, -1, 50));
        ...
        sidepane2.add(user, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, -1, -1));
        ...
        sidepane2.add(supply, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 200, -1, -1));
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/icon/product_32px.png"))); // NOI18N
        barang.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 0, 42, 50));

        jLabel14.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("Master Barang");
        barang.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(58, 11, 172, 39));

        sidepane2.add(barang, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 140, -1, -1));
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/icon/box_32px.png"))); // NOI18N
        pers.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 0, 42, 50));

        jLabel19.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(255, 255, 255));
        jLabel19.setText("Data Persediaan Barang");
        pers.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(58, 11, 172, 39));

        sidepane2.add(pers, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 260, -1, -1));
        ...
        sidepane2.add(trx, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 380, -1, 50));
        ...
        tnoo1.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        bg2.add(tnoo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 220, 190, 30));
        ...
        bg2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 220, -1, -1));
    ...
    private void btn_cetakMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_cetakMouseClicked
        this.Simpan();
        model.msg.cetstruk(this.tnoo1.getText());
        this.hapustable();
        this.awal();
    ...
    private javax.swing.JTextField tnoo1;
